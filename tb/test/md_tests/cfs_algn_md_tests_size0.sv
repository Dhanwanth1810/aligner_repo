///////////////////////////////////////////////////////////////////////////////
// File:        cfs_algn_md_tests_size0.sv
// Author:      Dhanwanth
// Date:        2025-06-23
// Description: size 0 test
///////////////////////////////////////////////////////////////////////////////
`ifndef CFS_ALGN_MD_TESTS_SIZE0_SV
`define CFS_ALGN_MD_TESTS_SIZE0_SV

class cfs_algn_md_tests_size0 extends cfs_algn_test_base;

  `uvm_component_utils(cfs_algn_md_tests_size0)
  ...
  virtual task run_phase(uvm_phase phase);
    ...
    for (int i = 0; i < 10; i++) begin
      ...
      #(50ns);
      rx_err_seq = cfs_algn_virtual_sequence_rx_err0::type_id::create($sformatf("rx_err_seq_%0d", i));
